...
variable "public_subnets" {
  ...
  default     = ["10.21.128.0/24", "10.21.192.64/26"]
}
...
variable "domain" {
  description = "Domain"
  default     = "recipes-staging.project.jitera.app"
}
